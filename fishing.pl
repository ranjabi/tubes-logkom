...
fish :-
    ...
    (
        ...
        exp_fishing(_ExpFish),
        level_fishing(_LvlFishing),
        level_fishing_rod(_LvlFishingRod),nl,
        % write('exp_fishing_rod: '),write(ExpRod),nl,!,
        % write('exp_fishing: '),write(_ExpFish),nl,!,
        % write('exp total: '),write(NewExpTotal),nl,!,
        % write('level_fishing: '),write(_LvlFishing),nl,!,
        % write('level_fishing_rod: '),write(_LvlFishingRod),nl,!,
...
fish :- 
    ...
    exp_fishing(_ExpFish),
    level_fishing(_LvlFishing),
    level_fishing_rod(_LvlFishingRod),
    % write('exp_fishing: '),write(_ExpFish),nl,!,
    % write('exp total: '),write(NewExpTotal),nl,!,
    % write('level_fishing: '),write(_LvlFishing),nl,!,
    % write('level_fishing_rod: '),write(_LvlFishingRod),nl,!,
